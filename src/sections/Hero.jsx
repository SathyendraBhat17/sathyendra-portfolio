      ...
      <div className="w-full max-w-6xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap gap-3 pt-8">
            <Button variant="primary" onClick={handleScrollToProjects} ariaLabel="View my projects">
              <span>View projects</span>
              <ArrowDown size={16} className="ml-2" />
            </Button>
            <Button variant="secondary" href={personalData.contact.github} ariaLabel="Open GitHub profile">
              <FaGithub size={16} className="mr-2" />
              <span>GitHub</span>
            </Button>
            <Button variant="secondary" href="https://www.linkedin.com/in/sathyendrabhat/" ariaLabel="Open LinkedIn profile">
        ...
        >
          <div className="profile-frame relative mx-auto mb-10 w-full max-w-[18rem] aspect-[4/5] overflow-hidden border border-border-primary bg-bg-surface">
            <img src={profilePhoto} alt="Sathyendra Bhat" className="h-full w-full object-cover object-center" />
          </div>
          <div className="border-t border-border-primary pt-4">
            <div className="flex items-start justify-between gap-5">
              <span className="text-xs font-mono uppercase tracking-widest text-text-secondary">Focus</span>
              <span className="max-w-[13rem] text-right text-sm leading-relaxed text-text-primary">
                Software engineering, artificial intelligence, and modern web technologies.
              </span>
            </div>
          </div>
          <div className="mt-6 border-t border-border-primary pt-4">
            <span className="block text-xs font-mono uppercase tracking-widest text-text-secondary">Currently</span>
            <span className="mt-2 block text-sm leading-relaxed text-text-primary">
              Building full stack applications and strengthening problem-solving fundamentals.
            </span>
          </div>
        </motion.div>
      </div>
